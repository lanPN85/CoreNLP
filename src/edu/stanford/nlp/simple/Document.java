...
public class Document {
  ...
  static final Properties CASELESS_PROPS = PropertiesUtils.asProperties(
        ...
        "tokenize.language", "en",
        "parse.binaryTrees", "true",
        "pos.model", "models/pos-tagger/wsj-0-18-caseless-left3words-distsim.tagger",
        "parse.model", "models/lexparser/englishPCFG.caseless.ser.gz",
        "ner.model", "models/ner/english.muc.7class.caseless.distsim.crf.ser.gz," +
                  "models/ner/english.conll.4class.caseless.distsim.crf.ser.gz," +
                  "models/ner/english.all.3class.caseless.distsim.crf.ser.gz");
