...
public class DependencyParser {
    ...
    public static final String DEFAULT_MODEL = "models/parser/nndep/english_UD.gz";
    ...
    private void parseStdIn(BufferedReader input, PrintWriter output){
        DocumentPreprocessor preprocessor = new DocumentPreprocessor(input, DocumentPreprocessor.DocType.Plain);
        preprocessor.setSentenceFinalPuncWords(config.tlp.sentenceFinalPunctuationWords());
        preprocessor.setEscaper(config.escaper);
        preprocessor.setSentenceDelimiter(config.sentenceDelimiter);
        preprocessor.setTokenizerFactory(config.tlp.getTokenizerFactory());
    ...
    public static void main(String[] args) {
        ...
        if (props.containsKey("textFile")) {
            ...
            if (inputFilename.equals("-")){
                parser.parseStdIn(input, output);
            }else {
