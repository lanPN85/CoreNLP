...
public class QuoteAttributionAnnotator implements Annotator {
  ...
  public static final String DEFAULT_MODEL_PATH = "models/quoteattribution/quoteattribution_model.ser";

  // these paths go in the props file
  public static String FAMILY_WORD_LIST = "models/quoteattribution/family_words.txt";
  public static String ANIMACY_WORD_LIST = "models/quoteattribution/animate.unigrams.txt";
  public static String GENDER_WORD_LIST = "models/quoteattribution/gender_filtered.txt";
  public static String COREF_PATH = "";
  public static String MODEL_PATH = "models/quoteattribution/quoteattribution_model.ser";
